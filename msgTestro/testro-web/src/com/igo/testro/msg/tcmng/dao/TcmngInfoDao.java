...
public class TcmngInfoDao {
	...
	public Integer getTcTotCnt(Map map) {
		...
		return (Integer)SqlMapper.getSqlClient("TESTRO_DB").queryForObject("tcmngInfo.getTcTotCnt", map);
	}
	...
	public ArrayList<TcDto> getTcList(Map map) {
		...
		result = (ArrayList<TcDto>)SqlMapper.getSqlClient("TESTRO_DB").queryForList("tcmngInfo.getTcTotList", map, (Integer)map.get("startnum") ,(Integer)map.get("endnum"));
		return result;
	}
	...
	public Integer getTdTotCnt(Map map) {
		...
		return (Integer)SqlMapper.getSqlClient("TESTRO_DB").queryForObject("tcmngInfo.getTdTotCnt", map);
	}
	...
	public ArrayList<TestDataDto> getTdList(Map map) {
		...
		result = (ArrayList<TestDataDto>)SqlMapper.getSqlClient("TESTRO_DB").queryForList("tcmngInfo.getTdTotList", map, (Integer)map.get("startnum") ,(Integer)map.get("endnum"));
		return result;
	}
	...
	public List<TestDataDetailDto> getTdDetailList(Map map) {
		...
		result = (List<TestDataDetailDto>)SqlMapper.getSqlClient("TESTRO_DB").queryForList("tcmngInfo.getTdDetailList", map);
		return result;
	}
}
