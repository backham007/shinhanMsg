...
<script type="text/javascript" src="js/msg/statistics/defPrgsSts.js" charset="utf-8"></script>
	                                ...
	                                <tr> 
	                                  <td valign="top"><table border=0 cellpadding=0 cellspacing=0 width=100%>
	                                    <tr>
	                                      ...
	                                      <td width="100" class="sub_tit">결함 총괄표</td>
	                                      <td valign="bottom" class="point_text" id="flowMsg" >조회된 내용을 더블클릭하여 테스트결과를 확인 할 수 있습니다.</td>
	                                    </tr>
	                                    <tr >
	                                                    ...
	                                                    <tr>
	                                                      <td bgcolor="#FFFFFF">
	                                                          <table width="100%" border="0" cellspacing="0" cellpadding="2">
	                                                              <tr>
		                                                                <td class="box_txt_red" style="width:95px;">프로젝트 :</td>
		                                                                <td><input id="projNo" type="text" class="input_topinq" style="width:90px" value="${sessionScope.userinfo.projno}">
		                                                                    <img src="images/btn_pop.gif" alt="프로젝트 조회" width="23" height="21" hspace="4" align="absmiddle" onClick="openProjPop('testStgeName')" style="cursor: pointer">
		                                                                <input id="projName" type="text" class="input_topinq" style="width:200px" value="${sessionScope.userinfo.projname}">
		                                                                
		                                                                <td width="120" class="box_txt">테스트단계 :</td>
		                                                                <td>
			                                                                <select id="testStgeName" class="menu" style="width:120px">
	                                                              ...
	                                                              <tr>
	                                                          		<td class="box_txt">조회기간 :</td>
	                                                                	<td width="450" colspan="1">
	                                                                		<input name="testStartYMS" id="testStartYMS" type="text" class="input_topinq" style="width:65px" readonly="readonly">
	                                                                ...
	                                                                <td class="box_txt">거래코드 :</td>
	                                                                <td><input id="tranCd" type="text" class="input_topinq" style="width:120px">
	                                                                <img src="images/btn_pop.gif" alt="거래코드 조회" width="23" height="21" hspace="4" align="absmiddle" onClick="getLayoutOpen();" style="cursor:pointer"></td>
	                                                                <td>&nbsp;</td>
	                                                              </tr>
	                                                              <tr>
	                                                                <td class="box_txt">결함진행상태 :</td>
	                                                                <td><select id="defCd" class="menu" style="width:90px">
	                                                                </select></td>
	                                    ...
	                                    <table width="100%" border="0" cellspacing="0" cellpadding="1">
	                                      ...
	                                      <tr>
	                                        ...
	                                        <td align="center"><span class="input_result">[오류현황을 더블클릭하시면 상세조회가 가능합니다.]</span></td>
	                                        <td width="150" id="excelBtn">
			                                        <table border="0" align="right" cellpadding="0" cellspacing="0">
				                                          <tr>
					                                            <td width="16" height="21" background="images/btn_img_01.gif">&nbsp;</td>
					                                            <td background="images/btn_img_02.gif" class="btn_text" onclick="downExcelDefPrgsSts();" style="cursor: pointer">엑셀다운로드</td>
					                                            <td width="10" background="images/btn_img_03.gif">&nbsp;</td>
				                                          </tr>
			                                        </table>
		                                        </td>
