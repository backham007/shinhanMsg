...
<script type="text/javascript" src="js/msg/statistics/prvtTestPrgsSts.js" charset="utf-8"></script>
<script type="text/javascript" src="js/cmn/util.js" charset="utf-8"></script>
<script language="javascript"><!--
var tranUrl = "msg.statistics.getPrvtTestPrgsSts.do";
var param = "";
var maxWidth= 750;
var leftTemp= 230;
	                                ...
	                                <tr> 
	                                  <td valign="top"><table border=0 cellpadding=0 cellspacing=0 width=100%>
	                                    <tr>
	                                      ...
	                                      <td width="120" class="sub_tit">개인별 진척현황</td>
	                                                          ...
	                                                          <table width="100%" border="0" cellspacing="0" cellpadding="2">
	                                                              ...
	                                                              <td class="box_txt">테스트대상시스템 :</td>
	                                                                ...
	                                                                <td>
	                                                                	...
	                                                                	<img src="images/btn_eraser.gif" alt="삭제" width="23" height="21" hspace="4" align="absmiddle" onclick="{$('#tstrName').val('');}" style="cursor: pointer">
	                                                                </td>
	                                                              </tr>
	                                                          </table>
	                                                      </td>
	                                      ...
	                                      <tr>
	                                        ...
	                                        <td width="150" id="excelBtn">
		                                        <table border="0" align="right" cellpadding="0" cellspacing="0">
		                                          <tr>
		                                            <td width="16" height="21" background="images/btn_img_01.gif">&nbsp;</td>
		                                            <td background="images/btn_img_02.gif" class="btn_text" style="cursor:pointer" onclick="downExcelprvtTestPrgsSts()">엑셀다운로드</td>
		                                            <td width="10" background="images/btn_img_03.gif">&nbsp;</td>
		                                          </tr>
		                                        </table>
		                                   </td>
