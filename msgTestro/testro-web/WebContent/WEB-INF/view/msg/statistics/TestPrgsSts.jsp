...
<script type="text/javascript" src="js/msg/statistics/testPrgsSts.js" charset="utf-8"></script>
	                                ...
	                                <tr> 
	                                  <td valign="top"><table border=0 cellpadding=0 cellspacing=0 width=100%>
	                                    <tr>
	                                      ...
	                                      <td width="120" class="sub_tit">단계별 진척현황</td>
	                                                      ...
	                                                      <td bgcolor="#FFFFFF">
	                                                          <table width="100%" border="0" cellspacing="0" cellpadding="2">
	                                                              <tr>
	                                                                ...
	                                                                <td width="360" colspan="1"><input id="projNo" type="text" class="input_topinq" style="width:100px" value="${sessionScope.userinfo.projno}">
	                                                                    <img src="images/btn_pop.gif" alt="프로젝트 조회" width="23" height="21" hspace="4" align="absmiddle" onClick="javascript:openProjPop('testStgeName2');" style="cursor: pointer">
	                                                                ...
	                                                                <td width="60">
		                                                                <table border="0" align="right" cellpadding="0" cellspacing="0">
		                                                                  <tr>
		                                                                    ...
		                                                                    <td background="images/btn_img_02.gif" id="srch_btn" class="btn_text" style="cursor:pointer;" >조 회</td>
		<!--                                                                    <td background="images/btn_img_02.gif" class="btn_text" onclick = 'javascript:getList();'><font style="cursor:pointer">조 회</td>-->
	                                                              ...
	                                                              <tr>
	                                                              	<td class="box_txt_red" colspan="1">조회구분 :</td>
	                                                                <td>
	                                    ...
	                                    <table width="100%" border="0" cellspacing="0" cellpadding="1">
	                                      ...
	                                      <tr>
	                                        ...
	                                        <table border="0" align="right" cellpadding="0" cellspacing="0">
	                                          <tr>
	                                            <td width="16" height="21" background="images/btn_img_01.gif">&nbsp;</td>
	                                            <td background="images/btn_img_02.gif" class="btn_text" style="cursor:pointer" onclick="downExcelTestPrgsSts()">엑셀다운로드</td>
	                                            <td width="10" background="images/btn_img_03.gif">&nbsp;</td>
	                                          </tr>
	                                        </table>
	                                       </td>
