...
<script type="text/javascript" src="js/msg/flaw/myFlawList.js"></script>
                                ...
                                <tr> 
                                  <td valign="top"><table border=0 cellpadding=0 cellspacing=0 width=100%>
                                    <tr>
                                      ...
                                      <td width="110" class="sub_tit">나의 결함조회</td>
                                      <td valign="bottom"><span class="point_text">조회버튼을 누르시면 케이스/시나리오별 결함목록을 보실 수 있습니다.</span></td>
                                    </tr>
                                    <tr >
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td><table border="0" align="right" cellpadding="0" cellspacing="0">
                                                                  <tr>
                                                                    ...
                                                                    <td background="images/btn_img_02.gif" class="btn_text" style="cursor:pointer" onClick="getListMyFlaw();">조 회</td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="1">
                                      ...
                                      <tr>
                                        ...
                                        <td align="right">
	                                        ...
	                                        <select id="defCd1" name="defCd1" class="menu" style="width:100px;" onChange="getListMyTCFlaw();">
										    </select>
										</td>
                                      </tr>
                                    </table>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="1">
                                      ...
                                      <tr>
                                        ...
                                        <td align="right">
                                        	<span class="tit"><img src="images/bullet_round_blue.gif" width="8" height="10" hspace="4"></span>
                                        	<span class="board_title">결함상태 :</span>
                                            <select id="defCd2" name="defCd2" class="menu" style="width:100px;" onChange="getListMyTSFlaw();">
                                          </select></td>
                                      </tr>
                                    </table>
                                    <table width="100%" height="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#baccdc">
