...
<script type="text/javascript" src="js/cmn/sysmng/loggerMng.js"></script>
...
<table border=0 cellpadding=0 cellspacing=0 width=100%>
                                            <tr> 
                                                ...
                                                <td width="115" class="sub_tit">로그레벨 관리</td>
                                                 <td valign="bottom" class="point_text" id="flowMsg" >로그레벨을 선택한후, 적용 버튼을 클릭하여, 로그레벨을 변경 할 수 있습니다.</td>
                      </tr>
                                            <tr > 
