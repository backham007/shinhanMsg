...
$(document).ready( function(){
	...
	//공통코드 콤보세팅
	getListMngCode('defCd1', 'DEFSTATUS', '03');	//결함상태
	getListMngCode('defCd2', 'DEFSTATUS', '03');	//결함상태
...
//나의재테스트 전체조회
function getListMyReTest(){
	getListMyTCReTest();
	getListMyTSReTest();
}

//테스트케이스 나의재테스트조회
function getListMyTCReTest(){
	...
	$('#list1').jqGrid('setGridParam',{url:"msg.flaw.getListMyTCReTest.do", datatype:"json", postData:param, page:1});
	$('#list1').trigger("reloadGrid");
}

//테스트시나리오 나의재테스트조회
function getListMyTSReTest(){
	...
	$('#list2').jqGrid('setGridParam',{url:"msg.flaw.getListMyTSReTest.do", datatype:"json", postData:param, page:1});
