...
public class TCPServer_8001 {
	...
	private ByteBuffer parseFlatMessage(ByteBuffer buffer) throws CharacterCodingException, UnsupportedEncodingException {
		...
		//레이아웃DB에서 거래코드 조회
		// 입력전문 식별 
		String strbuf = new String(buffer.array()).substring(206,214);
		...
		stringBuffer.append(new String(msg,"euc-kr"));
	...
	public static void main(String[] args) {
		...
		TCPServer_8001 s = new TCPServer_8001();
		s.execute();
	}
}
